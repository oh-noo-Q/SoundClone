...
const App = () => {
  ...
  const onChangeSearchForm = (event) =>
    setSearchForm({ ...searchForm, titleSearch: event.target.value });
      ...
      <Router>
        <div className="container-content">
          <Routes>
            <Route
              ...
              element={
                <div>
                  ...
                  {searchDataSongs.length > 0 ? (
                    <div className="searchDashboard">
                      <DashboardSearch searchDataSongs={searchDataSongs} />
                      <Button
                        text="Play List Search"
                        onClick={() => setDataSongsToPlay(searchDataSongs)}
                      />
                    </div>
                  ) : (
                    <div></div>
            ...
            <Route
              path="/about"
              element={<AboutUs aboutUsImg={aboutUsImg} />}
            />
          </Routes>
          ...
          <Routes>
            <Route
              exact
              path="/discovery"
              element={<ProtectedRoute Component={Discovery} />}
            />
          </Routes>
        </div>
        ...
        <Routes>
          <Route
            exact
            path="/login"
            element={<LoginForm authImg={aboutUsImg} />}
          />
          <Route
            exact
            path="/register"
            element={<RegisterForm authImg={aboutUsImg} />}
          />
        </Routes>
        ...
        <Routes>
          <Route
            path="/:somestring"
            element={<HeaderOthers littleLogo={aboutUsImg} />}
          />
        </Routes>

        {dataSongsToPlay.length > 0 ? (
